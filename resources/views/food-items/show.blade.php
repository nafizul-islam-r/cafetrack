            ...
            @can('is-admin')
                <div class="flex space-x-2">
                    ...
                    <form method="POST" action="{{ route('food-items.destroy', $foodItem) }}"
                        ...
                        @method('DELETE')
                        <button type="submit"
                            class="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-100 text-sm font-medium">
                            Delete
                        </button>
                    </form>
                </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <!-- Left Column: Item Details & Review Form -->
                <!-- Left Column: Item Details & Review Form -->
                <div
                    ...
                    <div>
                        ...
                        <p
                            class="text-md mt-2 {{ $foodItem->quantity > 0 ? 'text-gray-700 dark:text-gray-300' : 'text-red-600 dark:text-red-400' }}">
                ...
                </div><!-- Left Column: Item Details & Review Form -->
                                ...
                                <div class="border-b border-gray-200 dark:border-gray-700 pb-4">
                                    ...
                                    @can('is-admin')
                                        <form method="POST" action="{{ route('reviews.destroy', $review) }}"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button typeA="submit" class="text-red-500 hover:text-red-700 text-sm">Delete
                                                Review</button>
                                        </form>
                                    @endcan
                                </div>
